 ...
 */
public interface IntentDecomposer {

    void performAction(ServiceExtended service, Tracker tracker, DismiValidationServiceImpl.ValidationTypeEnum action);

    <T extends ServiceAction> void registerServiceDecomposer(Class<T> cls, IDismiServiceDecomposer<T> compiler);

    <T extends ServiceAction> void unregisterServiceDecomposer(Class<T> cls);
