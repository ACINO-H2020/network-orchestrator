 ...
 */
@Beta
public class AciPathIntent extends ConnectivityIntent {
     ...
     */
    protected AciPathIntent(ApplicationId appId,
                            Key key,
        ...
        super(appId, key, resources(path.links()), selector, treatment, constraints,
              priority);
        AciPathIntent.validate(path.links());
        this.path = path;
    }
    ...
    public static class Builder extends ConnectivityIntent.Builder {
         ...
         */
        public AciPathIntent build() {

            return new AciPathIntent(
                    appId,
                    key,
                    selector,
                    treatment,
