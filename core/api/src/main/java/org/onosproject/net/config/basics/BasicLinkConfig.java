...
public final class BasicLinkConfig extends AllowedEntityConfig<LinkKey> {
    ...
    public static final String LENGTH_IN_KM = "LengthInKm";
    ...
    public boolean isValid() {
        ...
        return hasOnlyFields(ALLOWED, TYPE, METRIC, LENGTH_IN_KM, LATENCY, BANDWIDTH, IS_DURABLE, IS_BIDIRECTIONAL) &&
                isBoolean(ALLOWED, OPTIONAL) && isNumber(METRIC, OPTIONAL) && isNumber(LENGTH_IN_KM, OPTIONAL) &&
    ...
    /**
     * Returns link length in terms of KM.
     *
     * @return link length; -1 if not set
     */
    public long lengthInKm() {
        return get(LENGTH_IN_KM, -1);
    }
