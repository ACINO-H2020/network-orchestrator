...
public interface IntentService
    ...
    /**
     * Returns the list of alternative intents acceptable for negotiation.
     * @param intentKey the intent key in NEGOTIATION_REQ state
     * @return intents with different constraint
     */
    List<Intent> getAlternativeSolutions(Key intentKey);
