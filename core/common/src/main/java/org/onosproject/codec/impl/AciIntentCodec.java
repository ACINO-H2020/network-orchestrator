 ...
 */
public final class AciIntentCodec extends JsonCodec<AciIntent> {
    ...
    @Override
    public ObjectNode encode(AciIntent intent, CodecContext context) {
        checkNotNull(intent, "AciIntent intent cannot be null");
    ...
    @Override
    public AciIntent decode(ObjectNode json, CodecContext context) {
        log.debug("Decoding ACI intent.");
        AciIntent.Builder builder = AciIntent.builder();
