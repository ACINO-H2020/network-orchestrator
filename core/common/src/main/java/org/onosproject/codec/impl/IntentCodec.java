...
public final class IntentCodec extends JsonCodec<Intent> {
    ...
    public Intent decode(ObjectNode json, CodecContext context) {
        ...
        if (type.equals(PointToPointIntent.class.getSimpleName())) {
            return context.codec(PointToPointIntent.class)
                    .decode(json, context);
            ...
            return context.codec(SinglePointToMultiPointIntent.class)
                    .decode(json, context);
        } else if (type.equals(AciIntent.class.getSimpleName())) {
            return context.codec(AciIntent.class).decode(json, context);
