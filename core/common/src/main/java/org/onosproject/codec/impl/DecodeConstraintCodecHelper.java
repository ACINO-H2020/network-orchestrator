...
import static org.onosproject.net.intent.constraint.NegotiableConstraint.negotiable;
...
public final class DecodeConstraintCodecHelper {
     ...
     * @return asymmetric path constraint object.
     */
    private Constraint decodeEncryptionConstraint() {
        return new EncryptionConstraint();
    }
     ...
     * @return asymmetric path constraint object.
     */
    private Constraint decodeLatencySensitiveConstraint() {
        return new LatencySensitive();
    }
    ...
    /**
     * Decodes a negotiable reallocation constraint.
     *
     * @return negotiable constraint object.
     */
    private Constraint decodeNegotiableConstraint() {
        return negotiable();
    }
    ...
    public Constraint decode() {
        ...
        } else if (type.equals(EncryptionConstraint.class.getSimpleName())) {
            return decodeEncryptionConstraint();
        } else if (type.equals(LatencySensitive.class.getSimpleName())) {
            return decodeLatencySensitiveConstraint();
        } else if (type.equals(NegotiableConstraint.class.getSimpleName())) {
            return decodeNegotiableConstraint();
