...
public enum LifecycleState {
  PLANNED("planned"), POTENTIAL("potential"), INSTALLED("installed"), PENDING_REMOVAL("pending-removal");
  ...
  private LifecycleState(String jsonName) {
    this.jsonName = jsonName;
  }

  @JsonCreator
  public static LifecycleState fromJsonString(String jsonString) {
