...
public class ConnectivityServiceEndPoint extends LocalClass implements Serializable {
  ...
  @JsonCreator
  public ConnectivityServiceEndPoint (@JsonProperty("local-id") String localId,
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), serviceInterfacePoint, role, direction, layerProtocolName);
  }
  ...
  public boolean equals(Object o) {
    ...
    ConnectivityServiceEndPoint that = (ConnectivityServiceEndPoint) o;
